...
var App = function () {
    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            var purge = this.parentElem.appendChild(this.purgeButton.render());
...
var taskList = new TaskList([new Task("Learn ES6 Festures"), new Task("Buy Dr. Stearns a Tesla"), new Task("Buy the iSchool a new building")]);
