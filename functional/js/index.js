...
let isKyle = isName("Kyle");
let kyles = BABYNAMES.filter(isKyle);
console.log(kyles);
...
console.log("Most popular female name:", sortedFemales[sortedFemales.length - 1]);
console.log("Most popular male name:", sortedMales[sortedMales.length - 1]);
...
console.log(top3FemaleJustNames.map(toLower).join(", "));
